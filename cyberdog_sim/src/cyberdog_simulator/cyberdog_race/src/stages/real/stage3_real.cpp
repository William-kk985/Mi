...
constexpr PathStep PATH[] = {
    ...
    { -40.0f, 0.6f },   // ② 右转40° 前0.6m (2026-08-21 用户: 50°→40°)
    { -17.0f, 1.8f },   // ③ 右转17° 前1.8m (2026-08-21 用户: 7°→17°)
    { +40.0f, 0.8f },   // ④ 左转40° 前0.8m (2026-08-21 用户: 与⑤换序, 40先50后)
    { +50.0f, 0.8f },   // ⑤ 左转50° 前0.8m (2026-08-21 用户: 40先50后)
...
void Stage3Real::init() {
    ...
    RCLCPP_INFO(rclcpp::get_logger("stage3_real"),
                "[Stage3Real] init: 写死路径 %d 步 (直行0.6+右30+右40+右17+左40+左50+左91)",
                PATH_N);
}
