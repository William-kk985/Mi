...
#else
    static constexpr float kFwdLatComp  = 0.023f; // (2026-08-22 用户: test2仍左偏, 0.020→0.023 右补再加)
    static constexpr float kFwdLatCompLow = 0.020f; // (2026-08-22 同步 0.017→0.020)
#endif
